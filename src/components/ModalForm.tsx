...
interface ModalFormProps {
  ...
  onSubmit: (formData: FormData) => void; // Function to handle form submission
}

interface FormData {
  title: string;
  rating: string; // Keeping as string for easier input handling
  status: string;
  cover: string;
}
...
const ModalForm: React.FC<ModalFormProps> = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validate rating field (optional, only if needed)
